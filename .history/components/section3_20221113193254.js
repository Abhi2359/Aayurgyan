    ...
    <div className="grid">
      ...
      <div className="info flex justify-center flex-col py-4">
          ...
          <div className="cat">
              ...
              <Link href={"/"} className="text-gray-800 hover:text-gray-600">- {published ||"Unlnown"}</Link>
          </div>
          <div className='title'>
      <Link href={"/"} className="text-3xl md:text-4xl font-bold text-gray-800 hover:text-gray-600">{title ||"No T"}</Link>
          </div>
