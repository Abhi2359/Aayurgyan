  ...
  <div className="container mx-auto flex justify-center py-12"> 
   <div className="py-5">
    ...
    <Link href={"https://www.facebook.com/groups/herbsmedicinalplants/?mibextid=HsNCOg"}><ImFacebook color="#1a1a00" /></Link>
        ...
        <p className="py-5 text-black text-xl font-extrabold">Copyright ©2022 All rights reserved | This blogging website is made to get access of knowledge about medicinal plants</p>
